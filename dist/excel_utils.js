...
exports.HandleCsvFile = exports.HandleExcelFile = void 0;
...
const excel_loader_1 = require("./loader/excel_loader");
const csv_loader_1 = require("./loader/csv_loader");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (let sheetName of excel.SheetNames) {
                ...
                const excelLoader = new excel_loader_1.ExcelLoader(worksheet, sheetName, fileName);
...
function HandleCsvFile(fileName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const csv = yield csv_loader_1.CSVLoader.load(fileName);
            if (csv == null) {
                utils.exception(`excel ${utils.yellow_ul(fileName)} open failure.`);
            }
...
exports.HandleCsvFile = HandleCsvFile;
////////////////////////////////////////////////////////////////////////////////
...
function HandleWorkSheetTypeColumn(worksheet, rIdx, RowMax, ColumnMax, DataTable, arrHeaderName) {
...
function HandleWorkSheetHighTypeColumn(worksheet, rIdx, RowMax, ColumnMax, DataTable, arrHeaderName) {
    for (; rIdx <= RowMax; ++rIdx) {
        const firstCell = worksheet.getData(arrHeaderName[0].cIdx, rIdx);
        if (firstCell == undefined || !utils.StrNotEmpty(firstCell.w)) {
            continue;
...
function HandleWorkSheetNameColumn(worksheet, rIdx, RowMax, ColumnMax, DataTable, arrHeaderName) {
    // find column name
    for (; rIdx <= RowMax; ++rIdx) {
...
function HandleWorkSheetDataColumn(worksheet, rIdx, RowMax, ColumnMax, DataTable, arrHeaderName) {
    for (; rIdx <= RowMax; ++rIdx) {
        let firstCol = true;
        const tmpArry = [];
...
function HandleDataTable(worksheet) {
