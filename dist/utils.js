...
const IgnoreColorFilterSheetSet = new Set();
function AddIgnoreSheet(sheetName) {
    IgnoreColorFilterSheetSet.add(sheetName);
}
exports.AddIgnoreSheet = AddIgnoreSheet;
//#endregion
////////////////////////////////////////////////////////////////////////////////
//#region Datas
...
function ExecGroupFilter(sheetName, arrGrpFilters, arrHeader) {
