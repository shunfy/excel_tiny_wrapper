...
exports.setTypeCheckerJSFilePath = exports.InitGlobalConfig = exports.gCfg = exports.gGlobalIgnoreDirName = exports.gRootDir = void 0;
...
function InitGlobalConfig(fpath = '') {
    ...
    if (utils.StrNotEmpty(exports.gCfg.TypeCheckerJSFilePath)) {
        setTypeCheckerJSFilePath(exports.gCfg.TypeCheckerJSFilePath);
    }
    return true;
}
exports.InitGlobalConfig = InitGlobalConfig;
function setTypeCheckerJSFilePath(jsPath) {
    if (!path.isAbsolute(jsPath)) {
        jsPath = path.join(exports.gRootDir, jsPath);
    }
    let jsFile = jsPath;
    ...
    CHighTypeChecker_1.CHightTypeChecker.TypeCheckerJSFilePath = jsPath;
    try {
        require(jsPath);
    }
    catch (ex) {
...
exports.setTypeCheckerJSFilePath = setTypeCheckerJSFilePath;
